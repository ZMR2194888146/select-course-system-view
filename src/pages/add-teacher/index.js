...
import {Table, message, Form, Input, Card, Button} from "antd";
...
class AddStudent extends React.Component {
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
            if (!err) {
                ...
                this.props.toRegisterTeacher(info);
            }
        })
    };
    ...
    render() {
        if (this.props.usertype === "admin") {
            ...
            return (
                <Card title="添加教师" style={{width: 500, margin: "20px auto"}}>
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <FormItem {...tailFormItemLayout}>
                            <Button htmlType="submit" type="primary" icon="plus">添加教师</Button>
                        </FormItem>
                    </Form>
                </Card>
            );
